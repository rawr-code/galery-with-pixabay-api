...
[![App preview](https://github.com/EmmanuelVillegas/react-typescript/master/img/preview.png)](#features)
...
**_See the [changelog] for what's new in the most recent release._**
...
- **TextMate** --- **_NOTE:_** Dark Theme is work in progress\
...
- **Mutt** e-mail client also by [me] (_just_ the Mutt colorscheme is
...
1.  **Selective contrast**
    ...
    Solarized reduces _brightness contrast_ but, unlike many low contrast
    colorschemes, retains _contrasting hues_ (based on colorwheel relations)
...
2.  **Both sides of the force**
    ...
    feel when switching between the light and dark background modes. A _lot_ of
